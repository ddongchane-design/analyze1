...
def main():
    video_ids = ["95_M8-DYUA8", "9fRankiszG4", "AbBJl3_G_s4"]
    output_path = Path("scratch/batch1_readable_part2.txt")
    ...
    print("Done writing to scratch/batch1_readable_part2.txt")
