...
def main():
    out_path = Path("scratch/batch6_info_utf8.txt")
    with open(out_path, "w", encoding="utf-8") as f_out:
        for fname in ["e9xfEnbaJo8.json", "dvMlz-kvaVc.json", "u_xgwtsAtbg.json", "XRcrf6PN3wI.json", "xzEEQZqfF1c.json"]:
            inspect_file(fname, f_out)
    print("Wrote to scratch/batch6_info_utf8.txt")
