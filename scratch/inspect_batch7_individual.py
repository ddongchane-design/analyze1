...
def main():
    out_path = Path("scratch/batch7_info_utf8.txt")
    with open(out_path, "w", encoding="utf-8") as f_out:
        for fname in ["_b1ZRGOvhCk.json", "S8Ww3ztKA9Y.json", "RVlWBnjF-oM.json", "bWxWET2_57g.json", "Ro9JNJkpTvY.json"]:
            inspect_file(fname, f_out)
    print("Wrote to scratch/batch7_info_utf8.txt")
